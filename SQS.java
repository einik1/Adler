...
public class SQS {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            CreateQueueRequest appToManagerQueueRequest = new CreateQueueRequest("appToManagerQueue");// add rand num
            ...
            CreateQueueRequest mangerToWorkersQueueRequest = new CreateQueueRequest("mangerToWorkersQueue");// add rand num
            ...
            CreateQueueRequest deadLetterQueueAppToManagerRequest = new CreateQueueRequest("deadLetterQueueAppToManager");// add rand num
            ...
            CreateQueueRequest deadLetterQueueManagerToWorkersRequest = new CreateQueueRequest("deadLetterQueueManagerToWorkers");// add rand num
            String deadLetterQueueManagerToWorkersURL = sqs.createQueue(deadLetterQueueManagerToWorkersRequest).getQueueUrl();
            
            GetQueueAttributesResult deadLetterQueueAppToManagerAttributes = sqs.getQueueAttributes(new GetQueueAttributesRequest(deadLetterQueueAppToManagerURL).withAttributeNames("QueueArn"));
            GetQueueAttributesResult deadLetterQueueManagerToWorkersrAttributes = sqs.getQueueAttributes(new GetQueueAttributesRequest(deadLetterQueueManagerToWorkersURL).withAttributeNames("QueueArn"));
            
            String deadLetterQueueAppToManagerArn = deadLetterQueueAppToManagerAttributes.getAttributes().get("QueueArn");       
            String deadLetterQueueManagerToWorkersArn = deadLetterQueueManagerToWorkersrAttributes.getAttributes().get("QueueArn");
            ...
            sqs.deleteQueue(new DeleteQueueRequest(mangerToWorkersQueueURL));
